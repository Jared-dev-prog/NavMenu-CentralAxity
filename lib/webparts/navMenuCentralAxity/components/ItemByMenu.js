...
var ItemByMenu = function (props) {
    ...
    return (React.createElement("li", null,
        React.createElement("span", { className: styles.text_color_white }, Title),
        React.createElement("ul", { className: styles.dropdown }, childrenList !== undefined
            ? childrenList.map(function (itemMenu, index) { return (React.createElement("div", { className: "dropdown-item", key: index, onClick: function () { return handleRedirect(itemMenu.Link); } },
                React.createElement("li", { className: styles.hover_black },
