...
import { PropertyPaneTextField, PropertyPaneButton, PropertyPaneButtonType, } from "@microsoft/sp-property-pane";
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endpointList = "".concat(this.properties.collectionData[0].route, "/_api/web/lists/getbytitle('").concat(listTitle, "')/items");
