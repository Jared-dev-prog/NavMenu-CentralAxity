...
// Module
exports.push([module.i, ".menu_ff1a0537{-ms-flex-pack:distribute;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;justify-content:space-around;list-style:none;padding:10px}.submenu_ff1a0537{background-color:#333;display:none;left:0;position:absolute;top:100%;width:200px;z-index:1}.submenu_ff1a0537 li{list-style:none;margin:0;padding:0}.nav_content_ff1a0537{font-family:Segoe UI,Tahoma,Geneva,Verdana,sans-serif;height:100%;width:100%}.nav_ff1a0537{-ms-flex-align:center;align-items:center;background:#3c1053;color:#e7e6f1;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-wrap:wrap;flex-wrap:wrap;list-style:none;margin:0 auto;padding-left:15px;padding-right:15px;position:relative;text-align:center;width:100%}.nav_ff1a0537 span{display:inline-block;padding-left:5px}.nav_ff1a0537>li{-ms-flex-positive:1;-ms-flex-negative:0;border-right:1px solid #72269d;cursor:pointer;flex-grow:1;flex-shrink:0;font-size:14px;height:60px;letter-spacing:1px;line-height:60px;position:relative;text-align:left}.nav_ff1a0537>li:hover{background:#72269d}.nav_ff1a0537>li:hover .dropdown_ff1a0537{transform:translate(0);visibility:visible;width:200px;z-index:1}.nav_ff1a0537>li:hover .dropdown_ff1a0537 li{padding-left:10px}.nav_ff1a0537>li:hover .dropdown_ff1a0537>li{animation-duration:.3s;animation-fill-mode:backwards;animation-name:slideInLeft_ff1a0537;animation-timing-function:ease-in-out}.nav_ff1a0537>li:hover .dropdown_ff1a0537 li:hover{background-color:#d8d5da}.nav_ff1a0537>li:first-child{border-top-left-radius:6px}.title_ff1a0537:after{color:#fff;content:\"\\25BC\";font-size:8px;padding:5px;text-align:start}.text_color_white_ff1a0537{color:#e7e6f1}.text_color_black_ff1a0537{color:#3c1053;font-size:12px;font-weight:400}.hover_black_ff1a0537:hover{background-color:#d8d5da}.dropdown_ff1a0537{background:#f1f1f1;border-bottom-left-radius:6px;border-bottom-right-radius:6px;box-shadow:1px 2px 5px -1px rgba(0,0,0,.15),0 4px 14px -1px rgba(0,0,0,.1);display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;left:0;list-style:none;margin:0;padding:0;position:absolute;right:0;top:100%;transform:translateY(-60px);transition:transform .2s ease-out,opacity .2s,z-index 0s .2s;visibility:hidden;z-index:-1}@keyframes slideInLeft_ff1a0537{0%{opacity:0;transform:translate(-25%)}to{opacity:1;transform:translate(0)}}", ""]);
// Exports
...
var styles = {
    menu: 'menu_ff1a0537',
    submenu: 'submenu_ff1a0537',
    nav_content: 'nav_content_ff1a0537',
    nav: 'nav_ff1a0537',
    dropdown: 'dropdown_ff1a0537',
    slideInLeft: 'slideInLeft_ff1a0537',
    title: 'title_ff1a0537',
    text_color_white: 'text_color_white_ff1a0537',
    text_color_black: 'text_color_black_ff1a0537',
    hover_black: 'hover_black_ff1a0537'
};
