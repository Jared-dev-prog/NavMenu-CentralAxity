...
var ItemByMenu = function (props) {
    ...
    /* eslint-disable */console.log(...oo_oo(`733082842_0`,"item 2 ", Title, Link, childrenList));
    var handleRedirect = function (url) {
        window.open(url);
    };
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("li", null,
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("span", { className: _NavMenuCentralAxity_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].text_color_white }, Title),
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("ul", { className: _NavMenuCentralAxity_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].dropdown }, childrenList !== undefined
            ? childrenList.map(function (itemMenu, index) { return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "dropdown-item", key: index, onClick: function () { return handleRedirect(itemMenu.Link); } },
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("li", { className: _NavMenuCentralAxity_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].hover_black },
...
// Module
exports.push([module.i, ".nav_content_8ad6928b{font-family:Segoe UI,Tahoma,Geneva,Verdana,sans-serif;font-weight:700;height:100%;overflow:hidden;width:100%}ul.nav_8ad6928b{-ms-flex-align:center;align-items:center;background:#3c1053;border-top-left-radius:6px;border-top-right-radius:6px;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-wrap:wrap;flex-wrap:wrap;list-style:none;margin:0 auto;padding:0;position:relative;width:100%}ul.nav_8ad6928b>li{-ms-flex-positive:1;-ms-flex-negative:0;border-right:1px solid #72269d;cursor:pointer;flex-grow:1;flex-shrink:0;font-size:14px;height:60px;letter-spacing:1px;line-height:60px;position:relative;text-align:center}.text_color_white_8ad6928b{color:#e7e6f1}.text_color_black_8ad6928b{color:#000}.hover_black_8ad6928b:hover{background-color:#d8d5da}ul.nav_8ad6928b>li:hover{background:#72269d}ul.nav_8ad6928b>li:hover ul.dropdown_8ad6928b{transform:translate(0);visibility:visible;z-index:1}ul.nav_8ad6928b>li:hover ul.dropdown_8ad6928b>li{animation-duration:.3s;animation-fill-mode:backwards;animation-name:slideInLeft_8ad6928b;animation-timing-function:ease-in-out}ul.nav_8ad6928b>li:first-child{border-top-left-radius:6px}ul.nav_8ad6928b>li:last-child{border-top-right-radius:6px}ul.dropdown_8ad6928b{background:#f1f1f1;border-bottom-left-radius:6px;border-bottom-right-radius:6px;box-shadow:1px 2px 5px -1px rgba(0,0,0,.15),0 4px 14px -1px rgba(0,0,0,.1);display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;left:0;list-style:none;margin:0;padding:5px 0 30px;position:absolute;right:0;top:100%;transform:translateY(-60px);transition:transform .2s ease-out,opacity .2s,z-index 0s .2s;visibility:hidden;width:200px;z-index:-1}ul.dropdown_8ad6928b>li{cursor:pointer;font-size:16px}ul.dropdown_8ad6928b>li:hover{background:rgba(250,1,1,.928)}@keyframes slideInLeft_8ad6928b{0%{opacity:0;transform:translate(-25%)}to{opacity:1;transform:translate(0)}}", ""]);
// Exports
...
var styles = {
    nav_content: 'nav_content_8ad6928b',
    nav: 'nav_8ad6928b',
    text_color_white: 'text_color_white_8ad6928b',
    text_color_black: 'text_color_black_8ad6928b',
    hover_black: 'hover_black_8ad6928b',
    dropdown: 'dropdown_8ad6928b',
    slideInLeft: 'slideInLeft_8ad6928b'
};
...
/* harmony import */ var bootstrap_dist_js_bootstrap_min_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(bootstrap_dist_js_bootstrap_min_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _NavMenuCentralAxity_module_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./NavMenuCentralAxity.module.scss */ "NZke");
/* harmony import */ var _ItemByMenu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ItemByMenu */ "+P1O");
...
var NavMenuCentralAxity = function (props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("nav", { className: _NavMenuCentralAxity_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].nav_content },
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("ul", { className: _NavMenuCentralAxity_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].nav }, listMenu !== undefined
            ? listMenu.map(function (itemMenu, index) { return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_ItemByMenu__WEBPACK_IMPORTED_MODULE_4__["default"], { key: index, Title: itemMenu.Title, Link: itemMenu.Link, childrenList: itemMenu.children })); })
            : "")));
};
