...
// Module
exports.push([module.i, ".menu_168c2273{-ms-flex-pack:distribute;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;justify-content:space-around;list-style:none;padding:10px}.submenu_168c2273{background-color:#333;display:none;left:0;position:absolute;top:100%;width:200px;z-index:1}.submenu_168c2273 li{list-style:none;margin:0;padding:0}.nav_content_168c2273{font-family:Segoe UI,Tahoma,Geneva,Verdana,sans-serif;height:100%;width:100%}.nav_168c2273{-ms-flex-align:center;align-items:center;background:#3c1053;color:#e7e6f1;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-wrap:wrap;flex-wrap:wrap;list-style:none;margin:0 auto;padding-left:15px;padding-right:15px;position:relative;text-align:center;width:100%}.nav_168c2273 span{display:inline-block;padding-left:5px}.nav_168c2273>li{-ms-flex-positive:1;-ms-flex-negative:0;border-right:1px solid #72269d;cursor:pointer;flex-grow:1;flex-shrink:0;font-size:14px;height:55%;letter-spacing:1px;line-height:60px;min-width:100px;position:relative;text-align:center}.nav_168c2273>li:hover{background:#72269d}.nav_168c2273>li:hover .dropdown_168c2273{transform:translate(0);visibility:visible;width:200px;z-index:1}.nav_168c2273>li:hover .dropdown_168c2273 li{line-height:35px;padding-left:10px;text-align:left}.nav_168c2273>li:hover .dropdown_168c2273>li{animation-duration:.3s;animation-fill-mode:backwards;animation-name:slideInLeft_168c2273;animation-timing-function:ease-in-out}.nav_168c2273>li:hover .dropdown_168c2273 li:hover{background-color:#d8d5da}.nav_168c2273>li:first-child{border-top-left-radius:6px}.title_168c2273:after{color:#fff;content:\"\\25BC\";font-size:8px;padding:5px;text-align:start}.text_color_white_168c2273{color:#e7e6f1}.text_color_black_168c2273{color:#3c1053;font-size:12px;font-weight:400}.hover_black_168c2273:hover{background-color:#d8d5da}.dropdown_168c2273{background:#f1f1f1;border-bottom-left-radius:6px;border-bottom-right-radius:6px;box-shadow:1px 2px 5px -1px rgba(0,0,0,.15),0 4px 14px -1px rgba(0,0,0,.1);display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;left:0;list-style:none;margin:0;padding:0;position:absolute;right:0;top:100%;transform:translateY(-60px);transition:transform .2s ease-out,opacity .2s,z-index 0s .2s;visibility:hidden;z-index:-1}@keyframes slideInLeft_168c2273{0%{opacity:0;transform:translate(-25%)}to{opacity:1;transform:translate(0)}}", ""]);
// Exports
...
var styles = {
    menu: 'menu_168c2273',
    submenu: 'submenu_168c2273',
    nav_content: 'nav_content_168c2273',
    nav: 'nav_168c2273',
    dropdown: 'dropdown_168c2273',
    slideInLeft: 'slideInLeft_168c2273',
    title: 'title_168c2273',
    text_color_white: 'text_color_white_168c2273',
    text_color_black: 'text_color_black_168c2273',
    hover_black: 'hover_black_168c2273'
};
